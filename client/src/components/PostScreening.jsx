    ...
    <>
        <div className='relative flex w-full flex-col items-center overflow-x-hidden'>        
            ...
            <div className="flex flex-col items-center px-8 pt-12">
                ...
                <h3 className='text-white/70 text-sm font-light leading-relaxed text-center max-w-xs italic'>Thank you for joining this private screening. Your perspective is invaluable to us.</h3>
            </div> 

            {/* Rating Section   */}
            <div className="flex flex-col items-center py-8">
                <h2 className='text-primary text-[10px] font-bold leading-normal tracking-[0.3em] uppercase mb-4'>Rate the Experience</h2>
            ...
            <div className="flex flex-col px-8 pb-12 space-y-6 max-w-[380px]">
                <div className="space-y-3">
                    <div className='text-white/40 text-xs font-bold uppercase leading-tight tracking-[0.2em] flex-1 text-center mt-6 align-center'>Private Remarks</div>
